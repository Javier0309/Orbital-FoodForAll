...
function CustFoodDesc() {
    ...
    // Correct "handleReviewRestaurant" and "handleViewRestaurant"
    const handleViewRestaurant = () => {
        if (!businessId || !businessId._id) {
            alert('Restaurant information not available');
            return;
        }

        navigate(`/restaurant/${businessId._id}`, {
            state: { restaurant: businessId }
        });
    };
    ...
    const handleReviewRestaurant = () => {
        ...
        navigate(`/restaurant/${businessId._id}/review`, {
            state: { restaurant: businessId }
        });
    };
